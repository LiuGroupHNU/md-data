...
void mdpu::soft_min_switch_force_grad_cpu(FPTYPE* grad_net,
                                            const FPTYPE* grad,
...
template void mdpu::soft_min_switch_force_grad_cpu<double>(
    double* grad_net,
    const double* grad,
...
template void mdpu::soft_min_switch_force_grad_cpu<float>(
    float* grad_net,
    const float* grad,
