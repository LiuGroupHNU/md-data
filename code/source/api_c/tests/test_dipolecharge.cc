...
TYPED_TEST(TestDipoleCharge, cpu_lmp_nlist) {
  ...
  mdpu::hpp::DipoleChargeModifier& dm = this->dm;
  // build nlist
  // float rc = dp.cutoff();
  float rc = 4.0;
