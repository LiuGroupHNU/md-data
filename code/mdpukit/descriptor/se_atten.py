...
from mdpukit.mdpu.descriptor.se_atten import (
    build_davg_dstd,
    build_op_descriptor,
    check_switch_range,
    descrpt2r4,
...
from mdpukit.utils.tabulate import (
    DPTabulate,
)
...
class DescrptSeAtten(DescrptSeA):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Constructor
        """
        if not (mdpu_cfg.enable and (mdpu_cfg.version == 1)):
    ...
    def compute_input_stats(
        ...
        **kwargs,
        ...
        ----------
        data_coord
            The coordinates. Can be generated by mdpukit.model.make_stat_input
        data_box
            The box. Can be generated by mdpukit.model.make_stat_input
        data_atype
            The atom types. Can be generated by mdpukit.model.make_stat_input
        natoms_vec
        ...
        mesh
            The mesh for neighbor searching. Can be generated by mdpukit.model.make_stat_input
        input_dict
    ...
    def build(
        ...
        dstd = self.dstd
        if mdpu_cfg.enable:
            mdpu_cfg.set_ntype(self.ntypes)
        ...
        op_descriptor = (
            build_op_descriptor() if mdpu_cfg.enable else op_module.prod_env_mat_a_mix
        )
        (
            self.descrpt,
            self.descrpt_deriv,
            ...
            with tf.variable_scope(name, reuse=reuse):
                ...
                if not self.stripped_type_embedding:
                    ...
                    if mdpu_cfg.enable:
                        ...
                        elif mdpu_cfg.restore_descriptor:
                            self.embedding_net_variables = (
                                mdpu_cfg.get_dp_init_weights()
                            )
    ...
    def build_type_exclude_mask(
        ...
        :meth:`mdpukit.descriptor.descriptor.Descriptor.build_type_exclude_mask`.
        ...
        See Also
        --------
        mdpukit.descriptor.descriptor.Descriptor.build_type_exclude_mask
        """
        # generate a mask
