...
from mdpukit.mdpu.descriptor.se_a import (
    build_davg_dstd,
    build_op_descriptor,
    check_switch_range,
    descrpt2r4,
...
class DescrptSeA(DescrptSe):
    ...
    :meth:`mdpukit.utils.network.embedding_net`.
    ...
    def compute_input_stats(
        ...
        **kwargs,
        ...
        natoms_vec
            The vector for the number of atoms of the system and different types of atoms. Can be generated by mdpukit.model.make_stat_input
        mesh
