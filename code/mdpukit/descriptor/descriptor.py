...
class Descriptor(PluginVariant):
    ...
    >>> type(descript)
    <class 'mdpukit.descriptor.se_a.DescrptSeA'>
    ...
    def compute_input_stats(
        ...
        **kwargs,
        ...
        data_coord : list[np.ndarray]
            ...
            :meth:`mdpukit.model.model_stat.make_stat_input`
        data_box : list[np.ndarray]
            The box. Can be generated by
            :meth:`mdpukit.model.model_stat.make_stat_input`
        data_atype : list[np.ndarray]
            The atom types. Can be generated by :meth:`mdpukit.model.model_stat.make_stat_input`
        natoms_vec : list[np.ndarray]
            The vector for the number of atoms of the system and different types of
            atoms. Can be generated by :meth:`mdpukit.model.model_stat.make_stat_input`
        mesh : list[np.ndarray]
