...
class MdpuConfig:
    r"""Configuration for MDPU
    record the message of model such as size, using mdpu or not.
    ...
    def __init__(self, jdata: dict):
        ...
        self.save_path = "mdpu/config.npy"
        self.weight = {}
    ...
    def disp_message(self):
        ...
        for message in MDPU_WELCOME + MDPU_CITATION + MDPU_CONFIG:
            log.info(message)
