...
def mdpu_args():
    doc_version = (
        "configuration the mdpu version (0 | 1), 0 for 4 types, 1 for 32 types"
    )
    doc_net_size_file = (
    ...
    doc_enable = "enable the mdpu training"
    ...
    doc_mdpu = "The mdpu options."
    return Argument("mdpu", dict, args, [], optional=True, doc=doc_mdpu)
